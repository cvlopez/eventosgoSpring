...
<%@page import="es.taw.eventosgo.entity.Evento"%>
...
<body>
<%
    List<EventoDTO> eventosDisponibles = (List)request.getAttribute("eventosDisponibles");
...
<!-- END SLIDES -->
<%
    for(EventoDTO evento : eventosDisponibles){
%>
